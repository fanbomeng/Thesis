...
%\caption{SM Higgs(m=125 GeV) production cross sections at $\sqrt{s}=8$ TeV and 13 TeV}
\begin{center}
...
%\footnote{The ttH production is at NLO QCD and NLO electro-weak accuracies while other production models listed here are at NNLO QCD and NLO electro-weak accuracies~\cite{Yellow_report}}
%\vspace{+4ex}
%\setlength{\skip\footins}{2cm}
%\begin{minipage}{0.9\textwidth} % choose width suitably
%{\footnotesize The ttH production is at NLO QCD and NLO electro-weak accuracies while other production models listed here are at NNLO QCD and NLO electro-weak accuracies~\cite{Yellow_report}.\par}
%\end{minipage}
\end{center}
\end{threeparttable}
%\end{threeparttable}
...
\end{equation}
Here, $y_{1}$ and $y_{2}$ are Yukawa couplings. If there is not a parity symmetry to distinguish the two Higgs doublets, there can be a coupling of the two doublets to the leptons in the tree level. In general it is impossible to diagonalize $y_{1}$ and $y_{2}$ simultaneously thus the LFV Higgs decay can be presented in the renormalizable Lagrangian~\cite{deLima2015}.% A bit more description of 2HDM is in the following~\cite{BRANCO20121}.   
